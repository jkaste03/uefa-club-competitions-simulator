...
// public QRoundSingleLegged(Tournament tournament, RoundType roundType,
// PathType pathType) {
...
// * @return a {@link NonKnockoutTie} instance representing the match between
// the
// * two clubs
// */
// @Override
// protected Tie newTie(ClubSlot club1, ClubSlot club2) {
// return new KnockoutTie(club1, club2, tournament);
// }
// }
