...
public class DoubleLeggedTie extends Tie {
    ...
    public float getRanking(Tournament callerTournament) {
        ...
        if (clubSlot1.isTie()) {
            ...
            if (winner != null) {
                if (clubSlot1.getTie().getTournament().compareTo(tournament) > 0) {
                    // assign loser
        ...
        if (clubSlot2.isTie()) {
            ...
            Boolean winner = innerTie.isClub1Winner();
            if (winner != null) {
                if (clubSlot2.getTie().getTournament().compareTo(tournament) > 0) {
                    // assign loser
        ...
        if (isClub1Winner() != null) {
            ...
            if (tournament.compareTo(callerTournament) > 0) {
                // Return loser's ranking
                return club1Won
                        ? clubSlot2.getRanking(tournament)
                        : clubSlot1.getRanking(tournament);
            } else {
        ...
        if (tournament.compareTo(callerTournament) > 0) {
            return Math.max(clubSlot1.getRanking(tournament), clubSlot2.getRanking(tournament));
        } else {
            return Math.min(clubSlot1.getRanking(tournament), clubSlot2.getRanking(tournament));
        }
    }
